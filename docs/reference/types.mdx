...
| Field | Type | Description |
|---|---|---|
| `away_team` | `['string', 'null']` *(optional)* |  |
| `home_team` | `['string', 'null']` *(optional)* |  |
| `id` | [`GameId`](#gameid) |  |
| `league` | `string` | Canonical league id (`League::id`). |
| `raw_status` | `['string', 'null']` *(optional)* | Verbatim ESPN status before normalization. Useful when `status` is `Unknown`. |
| `start_time` | `['string', 'null']` *(optional)* | Scheduled start time (UTC). |
| `status` | [`GameStatus`](#gamestatus) |  |
| `venue` | `['string', 'null']` *(optional)* | Optional venue name (stadium / arena). |
...
| Field | Type | Description |
|---|---|---|
| `date` | `['string', 'null']` *(optional)* | Calendar day (UTC). When set, returns games scheduled on that day. |
| `league` | `['string', 'null']` *(optional)* | League id (e.g., "nfl"). Required for ESPN — scoreboard endpoints are league-scoped. |
| `status` | [`GameStatus`](#gamestatus) \| `null` *(optional)* |  |
| `team` | `['string', 'null']` *(optional)* | Substring match against home/away team names. |
...
| Field | Type | Description |
|---|---|---|
| `clock` | `['string', 'null']` *(optional)* | Provider-formatted clock string (e.g., "12:34"). |
| `ended` | `boolean` |  |
| `game_id` | [`GameId`](#gameid) |  |
| `live` | `boolean` |  |
| `period` | `['string', 'null']` *(optional)* | Provider-formatted period label (e.g., "Q2", "Halftime"). |
| `raw_status` | `['string', 'null']` *(optional)* |  |
| `score` | [`Score`](#score) \| `null` *(optional)* |  |
| `status` | [`GameStatus`](#gamestatus) |  |
| `updated_at` | `string` |  |
...
| Field | Type | Description |
|---|---|---|
| `abbreviation` | `['string', 'null']` *(optional)* | Common abbreviation when present (e.g., "NFL"). |
| `id` | `string` | Canonical id used in ESPN URLs (e.g., "nfl", "nba", "usa.1"). |
| `name` | `string` | Human-readable display name. |
| `sport_id` | `string` | Parent `Sport::id`. |
...
| Field | Type | Description |
|---|---|---|
| `id` | `string` | Canonical id used in ESPN URLs (e.g., "football", "basketball"). |
| `name` | `string` | Human-readable display name. |
