...
- **kalshi**: `Exchange::fetch_user_activity()` implemented via `GET /portfolio/fills`, returning raw fill history JSON. `ExchangeInfo.has_fetch_user_activity` is now `true` for Kalshi.
