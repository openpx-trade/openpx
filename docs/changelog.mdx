...
- **core**: Adds `fetch_server_time` to the unified `Exchange` trait with a default `NotSupported` impl; exposes `has_fetch_server_time` flag on `ExchangeInfo` ([#26](https://github.com/openpx-trade/openpx/pull/26))
