...
|---------------|-----------------------------------------------------|---------|-------------------------|
| Rust SDK      | `rust/test_trading.rs`                              | 41      | ✓ 41 / 0 fail           |
...
sdks/python/.venv/bin/python e2e_tests/trading/docs/validate.py
```
