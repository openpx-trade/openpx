...
//! (`wss://sports-api.polymarket.com/ws`). No auth, no subscription messages —
//! connect and receive all active events. Uses TEXT-level `"ping"`/`"pong"`
//! keepalive (not WebSocket protocol pings).
//!
//! This is a Polymarket-specific convenience. For broader sports research,
//! use the ESPN client in `px-sports`.
